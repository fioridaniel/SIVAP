...
public class SafraComCondicoes {
    ...
    public SafraComCondicoes(int id_safra, int id_propriedade, int id_talhao, int id_variedade_cultura, 
                            Date dt_plantio, Date dt_colheita, BigDecimal producao, CondicaoClimatica condicaoClimatica) {
